...
<html>
    ...
    <body>
        ...
        <H1>Welcome Only a Matter of Thyme</h1>
 ...
 messageField.keypress(function(e) {
                    ...
                    try {
                        if (message.charAt(0) == "-") {
                            ...
                            if (messageSplit[0] == "-clear") {
                                ...
                                messagesRef.push({sender: "Only a Matter of Thyme", receiver: "Christina", text: message});
                                messageField.val('');
                        ...
                        //SAVE DATA TO FIREBASE AND EMPTY FIELD
                        messagesRef.push({sender: "Only a Matter of Thyme", receiver: "Christina", text: "Sorry your command is invalid"});
                        messageField.val('');
                    }
                }
            ...
            messagesRef.limitToLast(10).on('child_added', function(snapshot) {
                ...
                if (sender === "Only a Matter of Thyme" && receiver === "Christina" || sender === "Christina" && receiver === "Only a Matter of Thyme") {
                    messageList.append(senderElement)
                    messageList.append(message)
                    messageList.append("<li>")
                    messageList.append("Order key: " + key)
                    messageList.append("<li>")
                    messageList.append(ordercondition)
                    messageList.append("<li>")
                }
